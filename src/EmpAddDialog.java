...
public class EmpAddDialog extends JDialog {
    ...
    public EmpAddDialog(JFrame parent, SqlSessionFactory factory, Runnable onAdded) {
        ...
        tfHire = new JTextField();  // YYYY-MM-DD 형식
        tfResign = new JTextField(); // 선택 입력
        ...
        // 사원번호 필드 제거 (AUTO_INCREMENT 되므로 입력 불필요)
