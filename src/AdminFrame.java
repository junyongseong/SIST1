...
public class AdminFrame extends JFrame {
    ...
    public AdminFrame() throws IOException {
        ...
        bt_adminEmp.addActionListener(e -> cl.show(centerCard_p,"adminEmpCard"));

        bt_dsearch.addActionListener(e -> new EmpSearchDialog(AdminFrame.this).setVisible(true));

        bt_addEmp.addActionListener(e -> new EmpAddDialog(AdminFrame.this, factory, () -> loadEmpData()));

        bt_adminAtt.addActionListener(e -> {
            cl.show(centerCard_p, "adminAttCard");
            bt_find.addActionListener(ev -> {
